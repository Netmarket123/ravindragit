...
const reactNativeRun = [`run-${cliArgs.platform}`, reactNativeRunArguments];
console.log('react-native', ...reactNativeRun);
spawn('react-native', reactNativeRun, { stderr: 'inherit', stdio: 'inherit' });
